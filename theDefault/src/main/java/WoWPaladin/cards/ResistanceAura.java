...
import WoWPaladin.powers.ResistanceAuraPower;
import WoWPaladin.powers.RetributionPower;
...
public class ResistanceAura extends AbstractDynamicCard {
    ...
    public void use(final AbstractPlayer p, final AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new ResistanceAuraPower(p, this.magicNumber), this.magicNumber));
    }
