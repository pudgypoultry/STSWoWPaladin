...
public class BlindingLight extends CustomCard {
    ...
    Blinding Light - 1
    Common Skill
    All enemies get 1(2) weak, Gain 1(2) holy. Draw a card.
    */

    public static final String ID = WoWPaladin.makeID("BlindingLight");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom( new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new HolyPower(p, this.magicNumber), this.magicNumber));
