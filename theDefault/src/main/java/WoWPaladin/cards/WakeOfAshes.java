...
public class WakeOfAshes extends CustomCard {
     ...
     * Wake of Ashes
     * Rare Attack
     * Deal 15 Damage. Gain 5 Holy
     */

    // TEXT DECLARATION
    public static final String ID = WoWPaladin.makeID("WakeOfAshes");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(
                        AbstractDungeon.player, AbstractDungeon.player, new HolyPower(p, 5), 5));
