...
public class SealOfRighteousness extends AbstractOrb {

    // Standard ID/Description
    public static final String ORB_ID = WoWPaladin.makeID("SealOfRighteousness");
    private static final OrbStrings orbString = CardCrawlGame.languagePack.getOrbString(ORB_ID);
    public static final String[] DESC = orbString.DESCRIPTION;

    private static final Texture IMG = TextureLoader.getTexture(makeOrbPath("SealOfRighteousness.png"));
    ...
    public void onStartOfTurn() {// 1.At the start of your turn.
        ...
        AbstractDungeon.actionManager.addToBottom(// 3. Gains Block
                new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, passiveAmount)); //Block + Plated
                /*new com.megacrit.cardcrawl.actions.common.ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player,
                        new com.megacrit.cardcrawl.powers.PlatedArmorPower(AbstractDungeon.player, passiveAmount), passiveAmount)*/
    }
    ...
    public AbstractOrb makeCopy() {
        return new SealOfRighteousness();
    }
}
