...
public class StrikePaladin extends CustomCard {
    ...
    public static final String ID = WoWPaladin.makeID("StrikePaladin");
    ...
    public StrikePaladin() {
        ...
        this.tags.add(CardTags.STARTER_STRIKE); //Tag your strike, defend and form (Shadow form, demon form, echo form, etc.) cards so that they function correctly.
