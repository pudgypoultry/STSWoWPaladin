...
public class CrusadersJudgement extends CustomCard {
    ...
    */
    ...
    public static final String ID = WoWPaladin.makeID("CrusadersJudgement");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath("CrusadersJudgement.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(p, damage + magicNumber, damageTypeForTurn)));
